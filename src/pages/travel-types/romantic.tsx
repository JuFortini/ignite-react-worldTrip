...
export default function Romantic() {
  ...
  useEffect(() => {
    api.get("/types").then(city => setCities(city.data.romantic))
  }, [])
  ...
  return (
    <Flex direction="column" w="100%" align="center" justify="center" mb="16">
      <Header />
      <TypesBanner 
        bgImage="https://images.unsplash.com/photo-1529516222410-a269d812f320?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" 
        bgPosition="0% 80%"
        title="Romântico" 
      />
      <SimpleGrid  
